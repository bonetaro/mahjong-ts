...
export const WindChar = "w"; // 風牌 Winds
export const DragonChar = "d"; // 三元牌 Dragons
...
// 手牌を並び替えするときの牌種順
export const TileTypeSort = [ManduChar, PinduChar, SouduChar, WindChar, DragonChar] as const;
